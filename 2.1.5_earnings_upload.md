...
## API代码
loan_app:earnings:upload 

## 请求参数
| 名称 | 类型 | 是否必须 | 描述 | 示例值 |
| --- | --- | --- | --- | --- |
| appId | String | 是 | 申请ID | 0092728480d24f5d87bf63639b5cfe1c |
| fileName | String | 是 | 文件名称(包含后缀) | 系统07版企业财务报表.xlsx |
| base64OfFile | String | 是 | 文件转换成Base64编码(URLEncoder转码) | dfdasfdsaf2f2f2f2511dasfsdfsdfsdffdsdfafsdf10190dafffb4863168ec04== |
| mtFinRptCatCd | String | 是 | 财务报表范围代码 | 1 |
| mtFinRptTypCd | String | 是 | 财务报表类型代码 | 1 |
| mtFinStsCd | String | 是 | 财务报表状态代码 | 001 |
