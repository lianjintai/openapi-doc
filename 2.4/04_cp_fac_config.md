...
| 名称 | 类型 | 描述 |示例值 |
| --- | --- | --- | --- |
| cif | json | 授信时，客户信息所需要的数据字段及格式 |  |
| biz | json | 授信时，经营信息所需要的数据字段及格式 |  |
| rels | json | 授信时，主要成员所需要的数据字段及格式| |  
| contact | json | 授信时，主要成员中联系人所需要的数据字段及格式| |
| fac | json | 授信时，贷款产品所需要的数据字段及格式 | |  
| cols | json | 授信时，担保品所需要的数据字段及格式 | |
...
```
[接口完整字段配置](05_cp_app_field_all_config.html)
## FAQ
关于此文档暂时还没有FAQ