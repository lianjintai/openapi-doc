...
| csCollOwner | JSON(List) | 个人/企业所有人至少存在一个 | - | 担保所有人信息（个人）， 见[担保所有人信息（个人）](#担保所有人信息（个人）) ||
| cpCollOwner | JSON(List) | 个人/企业所有人至少存在一个 | - | 担保所有人信息（企业）， 见[担保所有人信息（企业）](#担保所有人信息（企业）) ||
